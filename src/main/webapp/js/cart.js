	...
	for(var i = 0; i < trs.length; i++) {
		...
		td.onclick = function() {
			...
			bt.onclick = function(event) {
				...
				var sprice=this.parentNode.parentNode.parentNode.previousElementSibling;
				var tprice=this.parentNode.parentNode.parentNode.nextElementSibling;
				
				inp.value = parseInt(inp.value.trim()) - 1 <= 0 ? 0 : parseInt(inp.value.trim()) - 1;
				tprice.innerText=fomatFloat(inp.value*parseFloat(sprice.innerText),2)+"元";
			};
			...
			inp.onblur = function() {
				...
				var bookid1=this.parentNode.parentNode.parentNode.nextElementSibling.value;
				var tt=this.parentNode.parentNode.nextElementSibling;
				modifyCount(bookid1,n,tt);
